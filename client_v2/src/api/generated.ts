import type {
    ...
    TlsConfig,
    TlsConfigBody,
    UpstreamDnsSourceAddRequest,
    UpstreamDnsSourceRemoveRequest,
    UpstreamDnsSourceSetRequest,
    UpstreamDnsSourcesRefreshResponse,
...
export const getUpstreamDnsSourcesStatusUrl = () => {
    return `control/upstream_dns_sources/status`;
};

/**
 * @summary Get upstream DNS source lists used for domain-specific routing
 */
export const upstreamDnsSourcesStatus = async (
    options?: RequestInit,
): Promise<UpstreamDnsSourcesStatus> => {
    return customFetch<UpstreamDnsSourcesStatus>(getUpstreamDnsSourcesStatusUrl(), {
        ...options,
        method: 'GET',
    });
};

export const getUpstreamDnsSourcesAddURLUrl = () => {
    return `control/upstream_dns_sources/add_url`;
};

/**
 * @summary Add an upstream DNS source URL or absolute file path
 */
export const upstreamDnsSourcesAddURL = async (
    upstreamDnsSourceAddRequest: UpstreamDnsSourceAddRequest,
    options?: RequestInit,
): Promise<void> => {
    return customFetch<void>(getUpstreamDnsSourcesAddURLUrl(), {
        ...options,
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...options?.headers },
        body: JSON.stringify(upstreamDnsSourceAddRequest),
    });
};

export const getUpstreamDnsSourcesRemoveURLUrl = () => {
    return `control/upstream_dns_sources/remove_url`;
};

/**
 * @summary Remove an upstream DNS source
 */
export const upstreamDnsSourcesRemoveURL = async (
    upstreamDnsSourceRemoveRequest: UpstreamDnsSourceRemoveRequest,
    options?: RequestInit,
): Promise<void> => {
    return customFetch<void>(getUpstreamDnsSourcesRemoveURLUrl(), {
        ...options,
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...options?.headers },
        body: JSON.stringify(upstreamDnsSourceRemoveRequest),
    });
};

export const getUpstreamDnsSourcesSetURLUrl = () => {
    return `control/upstream_dns_sources/set_url`;
};

/**
 * @summary Update an upstream DNS source
 */
export const upstreamDnsSourcesSetURL = async (
    upstreamDnsSourceSetRequest: UpstreamDnsSourceSetRequest,
    options?: RequestInit,
): Promise<void> => {
    return customFetch<void>(getUpstreamDnsSourcesSetURLUrl(), {
        ...options,
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...options?.headers },
        body: JSON.stringify(upstreamDnsSourceSetRequest),
    });
};

export const getUpstreamDnsSourcesRefreshUrl = () => {
    return `control/upstream_dns_sources/refresh`;
};

/**
 * @summary Refresh upstream DNS source lists
 */
export const upstreamDnsSourcesRefresh = async (
    options?: RequestInit,
): Promise<UpstreamDnsSourcesRefreshResponse> => {
    return customFetch<UpstreamDnsSourcesRefreshResponse>(getUpstreamDnsSourcesRefreshUrl(), {
        ...options,
        method: 'POST',
    });
};
